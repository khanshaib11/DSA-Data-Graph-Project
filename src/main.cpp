...
int main() {
	...
	std::string regNum, gender, eduLevel, jobTitle; int age, yearsExp, salary;
	...
	while (true) {
	    ...
	    if (choice == 1) {
	        ...
	        std::cout << "Enter registration number of the second employee: ";
	        std::cin >> regNum2;
	        std::cout<<std::endl<<"Shortest Distance : "<<system.shortestDistanceBetweenEmployees(regNum1, regNum2)<<std::endl<<std::endl;
	    } else if (choice == 7) {
